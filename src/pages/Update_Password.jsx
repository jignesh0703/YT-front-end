    ...
    return (
        <>
            ...
            <div className='flex justify-center mt-8'>
                <div className='flex justify-center items-center flex-col shadow-2xl w-max p-10 rounded-[15px]'>
                    ...
                    <form className='mt-2' onSubmit={SubmitHandler}>
                        ...
                        <div>
                            <button type="submit" className='flex justify-center items-center w-[25rem] h-[2.2rem] outline-none bg-[#F14A00] mt-4 text-[1.1rem] font-bold text-white rounded-[5px]'>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
