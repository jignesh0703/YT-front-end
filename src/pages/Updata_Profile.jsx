                    ...
                    ? <div className='flex justify-center mt-[2rem]'>
                        <div className='w-[80%]'>
                            <div className='w-full justify-center flex flex-col items-center'>
                                <img src={data.coverimage} alt="cover_image" className='w-[60%] h-[12rem]' />
                            ...
                            <div className='flex justify-center gap-[20rem] mt-8'>
                                <div className='w-max justify-center items-center mt-3'>
                                    <img src={data.avatar} alt="avatar" className='w-[8rem] h-[8rem] rounded-full' />
                                    <div className='flex justify-center'>
                                        <label htmlFor="cover_image" className='text-blue-500 font-bold cursor-pointer border-b-[1.5px] border-blue-500 transition duration-200'>
                                            Change Avatar
                                        </label>
                                    </div>
                                ...
                                <form onSubmit={SubmitHandler}>
                                    ...
                                    <div>
                                        <button type="submit" className='flex justify-center items-center w-[25rem] h-[2.2rem] outline-none bg-[#F14A00] mt-3 text-[1.1rem] font-bold text-white rounded-[5px]'>Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
